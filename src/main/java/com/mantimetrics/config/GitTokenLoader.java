 ...
 */
public final class GitTokenLoader {
    private final LoaderSupport propertiesLoaderSupport;

    /**
     * Creates a loader using the default properties helper.
     */
    public GitTokenLoader() {
     ...
     */
    GitTokenLoader(LoaderSupport propertiesLoaderSupport) {
