...
import com.mantimetrics.datasetOutput.DatasetColumns;
 ...
 */
public final class MilestoneAuditWriter {
    private static final ObjectMapper JSON = new ObjectMapper().enable(SerializationFeature.INDENT_OUTPUT);

    private final CSVReader tableReader;
     ...
     */
    public MilestoneAuditWriter(CSVReader tableReader) {
    ...
    public void write(
            ...
            ReleaseLabeling.Summary labelingSummary,
            double linkageRate
    ) throws IOException {
     ...
     */
    @NotNull
    private static Map<String, Object> getStringObjectMap(ReleaseLabeling.Summary labelingSummary) {
