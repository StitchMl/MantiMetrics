 ...
 */
public final class CohesionFeatureCalculator {
    ...
    public int calculateLcom4(TypeDeclaration<?> type) {
        List<MethodDeclaration> methods = JavaTypeUtility.directMethods(type);
        List<FieldDeclaration> fields = JavaTypeUtility.directFields(type);
