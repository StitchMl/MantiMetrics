...
public record GitConfig(String owner, String name, String repoUrl, Integer percentage,
    ...
    public GitConfig(
        ...
        GitOwnerRepoCoordinates coordinates = GitURLParsing.resolve(owner, name, repoUrl);
     ...
     * @param jiraProjectKey Jira project key associated with the repository
     */
    public GitConfig(String owner, String name, Integer percentage, String jiraProjectKey) {
