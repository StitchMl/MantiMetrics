...
public final class GitService {
    ...
    public List<String> listTags(String o,String r) throws IOException, InterruptedException {
        ...
        for (int p=1;;p++) {
            JsonNode arr = apiClient.getApi(API + REPOS + o + '/' + r + "/tags?per_page=100&page=" + p);
    ...
    public Map<String,List<String>> getFileToIssueKeysMap(String o,String r,String branch)
        ...
        return commitMapper.getFileToIssueKeysMap(o,r,branch);
    }
    ...
    public List<Path> getTmp() { return zipDownloader.getTmpDirs(); }
}