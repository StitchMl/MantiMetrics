...
import com.mantimetrics.config.LoaderSupport;
 ...
 */
final class JiraConfigLoader {
    private final LoaderSupport propertiesLoaderSupport = new LoaderSupport();
     ...
     */
    JiraProjectState load(Class<?> resourceOwner, String propsPath, String projectKey) throws JiraClientException {
        try {
            ...
            return JiraProjectState.fromProperties(properties, projectKey);
