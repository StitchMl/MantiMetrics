...
public final class ProjectSelection {
     ...
     */
    public ProjectSelection(InputStream input, PrintStream output) {
     ...
     */
    public GitConfig prompt(GitConfig[] configuredProjects) throws IOException {
     ...
     * @throws IOException when the CLI input stream closes unexpectedly
     */
    private GitConfig promptCustomProject() throws IOException {
        ...
        return new GitConfig(null, null, repoUrl, percentage, jiraKey, null);
    }
