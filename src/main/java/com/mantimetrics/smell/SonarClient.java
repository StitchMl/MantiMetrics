...
public final class SonarClient implements AutoCloseable {
     ...
     */
    public SonarClient(String token) {
     ...
     * @param token optional Bearer token; may be {@code null} for public projects
     */
    SonarClient(CloseableHttpClient httpClient, String token) {
     ...
     */
    public List<SonarAnalysis> fetchAnalyses(String projectKey) throws SonarException {
        ...
        try {
            ...
            throw new SonarException("Failed to fetch analyses for " + projectKey, e);
        }
    ...
    public Map<String, Integer> fetchFileSmells(String projectKey, String analysisKey)
        ...
        try {
            ...
            throw new SonarException("Failed to fetch file smells for " + projectKey
    ...
    static String normalizeSonarPath(String projectKey, String rawKey) {
        ...
        return PathUtility.normalizeDatasetPath(relative);
    }

    private JsonNode get(URI uri) throws IOException, SonarException {
        ...
        try (CloseableHttpResponse response = httpClient.execute(request)) {
            ...
            if (code != 200) {
                throw new SonarException("SonarCloud HTTP " + code + " for " + uri + " -> " + body);
            }
