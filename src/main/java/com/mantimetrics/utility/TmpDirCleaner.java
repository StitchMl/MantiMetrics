 ...
 */
public final class TmpDirCleaner {
    private static final Logger LOG = LoggerFactory.getLogger(TmpDirCleaner.class);

    /**
     * Prevents instantiation of the static utility class.
     */
    private TmpDirCleaner() {
        throw new AssertionError("Do not instantiate TmpDirCleaner");
    }
